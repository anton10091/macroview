...
const LeafletMap = dynamic(() => import('./LeafletMap'), { ssr: false, loading: () => <div style={{ height:420, background:'#a8d0e8', borderRadius:'12px 12px 0 0', display:'flex', alignItems:'center', justifyContent:'center' }}><span style={{ fontFamily:'monospace', fontSize:12, color:'#6a6460' }}>Загрузка карты…</span></div> })
...
function SiamMap({ period }) {
  return <LeafletMap period={period} />
}
